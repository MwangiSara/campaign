...
<div class="main-card mb-3 card">
    ...
    <h5 class="card-title" >REPORT<span class="font-weight-light">#CMS<?=$row['Campaign_Id']?></span></h5>
    </div>
<div class="card-body">
        ...
        <div class="scrollbar-container ps--active-y">
            <div class="row">
                <div class="col-12">
                  ...
                  <h7 class="card-title">Date: <span class="font-weight-light"><?=$row['Campaign_ActualStartDate']?>-<?=$row['Campaign_ActualEndDate']?></span></h7><br>
                  <h7 class=""><?=$row['campaign_desc']?></h7>
                </div>
              </div>
              <div class="row">
              <div class="col-6">
